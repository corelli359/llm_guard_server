...
from .rule_engine_view import create_rule_engine_router, create_rule_engin_air_router
...
def create_routers(app: Sanic):
    ...
    db_router, reload_router = create_db_router(app)
    rule_air_router = create_rule_engin_air_router(app)
    app.blueprint([
        sensitive_router,
        guard_router,
        rule_engine_router,
